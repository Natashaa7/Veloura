		...
		<div class="parallax">
			...
			<div class="navbar">
				<nav>
					...
					<a href="logout" class="redirect"><i class="fa-solid fa-arrow-right-from-bracket"></i>LOGOUT</a>
				</nav>
			</div>
			
				<!-- <li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/system/search.png"/></a></li> -->
